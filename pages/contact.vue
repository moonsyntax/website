    ...
    <section class="py-20 md:py-32 overflow-hidden">
      <div class="m-auto container">
        <div class="max-w-2xl text-center mx-auto mb-20">
          ...
          >
          <h1
            class="font-heading text-5xl xs:text-6xl font-bold text-gray-900 mb-4"
          >
        ...
        <div class="max-w-md lg:max-w-6xl mx-auto">
          <div class="flex flex-wrap">
            ...
            <div class="w-full lg:w-1/2 px-4 mb-12 lg:mb-0">
              <div class="max-w-md py-6 lg:ml-auto">

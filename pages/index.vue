		...
		<div class="flex flex-wrap -mx-4">
			...
			<div class="w-full lg:w-1/2 p-4">
				<div class="flex flex-col items-stretch sm:items-start justify-center h-full">
					<h2 class="text-4xl font-bold font-heading mb-6 max-w-sm">MOON { SYNTAX }</h2>
					...
					<div class="bg-purple-50 rounded-lg px-2 py-1 flex items-center gap-2">
						<svg

		...
		<section class="grid grid-cols-1 lg:grid-cols-2 gap-2">
			<div class="m-auto lg:p-0 p-8">
				...
				<div class="my-8 text-2xl text-left">
					The decentralized { organization } that's shaking up the world of blockchain { startups }. With a focus on { developing }, { managing }, and { funding } cutting-edge projects, our team of { experts } delivers unparalleled support and guidance.
				</div>
